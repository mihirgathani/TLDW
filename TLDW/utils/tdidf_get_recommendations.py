...
def get_tdidf_recs(input_transcript, ted_or_podcast):
    ...
    if ted_or_podcast == "ted":
        ...
        data_df = pd.read_csv("./TLDW/TLDW/data/ted_tdidf_preprocessed.csv")
        tfidf_vectorizer = joblib.load('./TLDW/TLDW/data/ted_tfidf_vectorizer.joblib')
        transcripts = data_df['transcript']
    else:
        # Load Podcast Dataset
        data_df = pd.read_csv("./TLDW/TLDW/data/podcast_tdidf_preprocessed.csv")
        tfidf_vectorizer = joblib.load('./TLDW/TLDW/data/podcast_tfidf_vectorizer.joblib')
