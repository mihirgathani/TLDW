...
def load_data(ted_or_podcast):
    ...
    if ted_or_podcast == "ted":
        ...
        data_df = pd.read_csv("./TLDW/TLDW/data/ted_talks_en.csv")
        with open('./TLDW/TLDW/data/ted_sentTrans_embeddings.pkl', 'rb') as file:
            embeddings = pickle.load(file)
    else:
        # Load Podcast Dataset
        data_df = pd.read_csv("./TLDW/TLDW/data/skeptoid_transcripts.csv")
        data_df = data_df.dropna(subset=['text'])
        with open('./TLDW/TLDW/data/podcast_sentTrans_embeddings.pkl', 'rb') as file:
            embeddings = pickle.load(file)
